...
最推荐的用法是直接把这段给 AI。复制时，先把你的主题、素材、页数和每页要点写到 `【PPT 内容：把你的需求写在这里】` 下面；`【工程说明】` 一般不用改。
...
【工程说明】
项目地址：https://github.com/vibe-lark/lark-deckkit
...
如果不在本地仓库里，再读取 GitHub 版本：
- https://github.com/vibe-lark/lark-deckkit/blob/main/design.md
- https://github.com/vibe-lark/lark-deckkit/blob/main/sdk/README.md
- https://github.com/vibe-lark/lark-deckkit/blob/main/product-mocks/README.md
